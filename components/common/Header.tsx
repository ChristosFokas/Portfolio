            ...
            {navOpen && (
                <nav className="md:hidden bg-black text-white text-sm text-center">
                    <div className="flex flex-col space-y-2 px-4 py-2">
                        ...
                        <a href="#profile" className="hover:text-red-700" onClick={toggleNav}>
                            PROFILE
                        </a>
                        <a href="#history" className="hover:text-red-700" onClick={toggleNav}>
                            HISTORY
                        </a>
                        ...
                        <a href="#photos" className="hover:text-red-700" onClick={toggleNav}>
                            PHOTOS
                        </a>
                        <a href="#followme" className="hover:text-red-700" onClick={toggleNav}>
                            FOLLOW ME
                        </a>
                        <a href="#contact" className="hover:text-red-700" onClick={toggleNav}>
                            CONTACT
                        </a>
                    </div>
                </nav>
